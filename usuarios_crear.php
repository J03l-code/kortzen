...
<div class="form-modal">
    ...
    <form method="POST" action="api/usuarios_action.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="biografia" class="form-input" rows="4"
                placeholder="Breve descripción del barbero..."><?php echo $isEdit ? htmlspecialchars(!empty($usuario['biografia']) ? $usuario['biografia'] : ($usuario['bio'] ?? '')) : ''; ?></textarea>
        </div>
        ...
        <?php if (!$isEdit): ?>
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-input" placeholder="••••••••" <?php echo !$isEdit ? 'required' : ''; ?>>
            </div>
        <?php endif; ?>
